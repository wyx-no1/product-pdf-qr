...
5. Use the Advisor Workspace Resolver to inspect the source at code commit
   `668b7b1842941c5bdc2c85fbc348bd724670e87d` in detached HEAD state.

The original Evidence files are in `docs/evidence/pr-28/` on branch
`docs/req-v2-header-contract`. The source of record is the repository at code commit
`668b7b1842941c5bdc2c85fbc348bd724670e87d`.
