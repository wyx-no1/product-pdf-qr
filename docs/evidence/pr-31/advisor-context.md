...
5. Use the Advisor Workspace Resolver to inspect the source at code commit
   `a5366b6cc8f6e36cd21b5e047b02e1936d7503ed` in detached HEAD state.

The original Evidence files are in `docs/evidence/pr-31/` on branch
`fix/review-gate-bare-verdict-headings`. The source of record is the repository at code commit
`a5366b6cc8f6e36cd21b5e047b02e1936d7503ed`.
