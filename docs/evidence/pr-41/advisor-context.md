...
5. Use the Advisor Workspace Resolver to inspect the source at code commit
   `46f03da3fbc8e55a0227707db5fabbc22380a09d` in detached HEAD state.

The original Evidence files are in `docs/evidence/pr-41/` on branch
`feat/deploy-pr2b-rollback`. The source of record is the repository at code commit
`46f03da3fbc8e55a0227707db5fabbc22380a09d`.
