...
5. Use the Advisor Workspace Resolver to inspect the source at code commit
   `a2bc83650846994a6a3124adced28c8444da1aa0` in detached HEAD state.

The original Evidence files are in `docs/evidence/pr-29/` on branch
`feat/excel-import`. The source of record is the repository at code commit
`a2bc83650846994a6a3124adced28c8444da1aa0`.
