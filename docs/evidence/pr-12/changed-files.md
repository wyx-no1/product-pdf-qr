...
Comparison: `origin/main...279b970471cce613c6ad7eb3f8501936afebf036` (three-dot)
...
```bash
git diff origin/main...279b970471cce613c6ad7eb3f8501936afebf036 -- migrations/ docs/requirements-v1.md docs/requirements-v2.md CLAUDE.md docs/quality-gates-v1.md docs/advisor-protocol-v1.md docs/decision-register-v1.md docs/test-plan-v1.md
```

The complete changed-path list can be reproduced without relying on this file:

```bash
git diff --name-status origin/main...279b970471cce613c6ad7eb3f8501936afebf036 -- . ':(exclude)docs/evidence/**'
```
