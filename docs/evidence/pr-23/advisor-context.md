...
5. Use the Advisor Workspace Resolver to inspect the source at code commit
   `363b46c2045d2eff4997c9130e7bcc9d5de1d209` in detached HEAD state.

The original Evidence files are in `docs/evidence/pr-23/` on branch
`docs/req-v2-product-name`. The source of record is the repository at code commit
`363b46c2045d2eff4997c9130e7bcc9d5de1d209`.
